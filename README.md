This is the program for the **thirteenth** RetroBattlestations BASIC
challenge. 

Role playing games are something that haven't waned at all in
popularity, and of course have many computerized incarnations besides
the old fashioned pen & paper. The combat of a computerized RPG lends
itself well to BASIC since it doesn't require fast compute and
everything is turn based.

The program is a very basic (heh) combat simulator which is quite
short and shouldn't pose a difficulty to type in. This program is also
a good starting point upon which more advanced features could be added
in, see the Enhancement Ideas section below.
...
* Character generator
* Serial or modem play
* FujiNet online connection
* Graphics
* Sound effects
...
work on your machine, try running the MSX version in an
